...
GCC_BIN = 
PROJECT = LoRaWAN_GPS
OBJECTS = ./main.o ./SX1276Lib/sx1276/sx1276.o ./SX1276Lib/sx1276/sx1276-hal.o ./SX1276Lib/radio/radio.o ./LoRaMacLib/system/utilities.o ./LoRaMacLib/mac/LoRaMac.o ./LoRaMacLib/mac/crypto/LoRaMacCrypto.o ./LoRaMacLib/mac/crypto/crptoCore/cmac.o ./LoRaMacLib/mac/crypto/crptoCore/aes.o ./LoRaMacLib/board/board.o ./LoRaMacLib/board/NVIC_set_all_priorities.o ./LoRaMacLib/board/timer.o ./TinyGPS/TinyGPS.o ./Chainable_RGB_LED/ChainableLED.o 
...
INCLUDE_PATHS = -I. -I./SX1276Lib -I./SX1276Lib/registers -I./SX1276Lib/sx1276 -I./SX1276Lib/enums -I./SX1276Lib/debug -I./SX1276Lib/typedefs -I./SX1276Lib/radio -I./LoRaMacLib -I./LoRaMacLib/system -I./LoRaMacLib/mac -I./LoRaMacLib/mac/crypto -I./LoRaMacLib/mac/crypto/crptoCore -I./LoRaMacLib/board -I./TinyGPS -I./Chainable_RGB_LED -I./mbed -I./mbed/TARGET_NUCLEO_L152RE -I./mbed/TARGET_NUCLEO_L152RE/TARGET_STM -I./mbed/TARGET_NUCLEO_L152RE/TARGET_STM/TARGET_STM32L1 -I./mbed/TARGET_NUCLEO_L152RE/TARGET_STM/TARGET_STM32L1/TARGET_NUCLEO_L152RE -I./mbed/TARGET_NUCLEO_L152RE/TOOLCHAIN_GCC_ARM 
...
CC_SYMBOLS = -DTARGET_FF_ARDUINO -DTOOLCHAIN_GCC_ARM -DTOOLCHAIN_GCC -DTARGET_FF_MORPHO -DTARGET_CORTEX_M -DMBED_BUILD_TIMESTAMP=1446171583.59 -DARM_MATH_CM3 -DTARGET_STM32L1 -DTARGET_STM -D__CORTEX_M3 -DTARGET_NUCLEO_L152RE -DTARGET_M3 -DTARGET_STM32L152RE -D__MBED__=1 
